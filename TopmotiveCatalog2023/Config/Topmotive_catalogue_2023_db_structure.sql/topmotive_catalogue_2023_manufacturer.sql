...
CREATE TABLE `manufacturer` (
  ...
  `contact_phone` varchar(16) COLLATE utf8mb3_bin DEFAULT NULL,
  `picture` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL,
  `short_code` varchar(10) COLLATE utf8mb3_bin DEFAULT NULL,
  `type` enum('Car','Assembly only','Both car and assemblies') COLLATE utf8mb3_bin NOT NULL DEFAULT 'Both car and assemblies',
  PRIMARY KEY (`id`),
